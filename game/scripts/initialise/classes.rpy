init python:   
    ...
    Rooms.append(place("Biblioteca",25000,False))
    Rooms.append(place("Sótão",40000,False))
    Rooms.append(place("Quarto Luxuoso",80000,False))
    Rooms.append(place("Banheira",1000,False))
